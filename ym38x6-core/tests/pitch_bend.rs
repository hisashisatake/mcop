...
use ym38x6_core::{waveform_memory_patch, AdsrParams, SoundEngine, Ym38x6Engine};
...
fn render_freq_with_bend(bend_cents: f32) -> f32 {
    ...
    engine.note_on_with_velocity(ch, 440.0, 127, waveform_memory_patch(0, sustained_adsr()));
...
fn pitch_bend_group_applies_to_matching_midi_channel() {
    ...
    engine.note_on_with_velocity(id_a, 440.0, 127, waveform_memory_patch(0, sustained_adsr()));
    engine.note_on_with_velocity(id_b, 880.0, 127, waveform_memory_patch(0, sustained_adsr()));
    engine.note_on_with_velocity(other, 440.0, 127, waveform_memory_patch(0, sustained_adsr()));
