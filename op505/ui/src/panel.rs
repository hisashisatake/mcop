...
use crate::selector::{
    enum_selector, fg_rate_selector, sync_rate_selector, CHORUS_TYPE_NAMES, FILTER_TYPE_NAMES, RATE_RANGE_NAMES,
    REVERB_TYPE_NAMES, RETRIGGER_MODE_NAMES, TEXTURE_NAMES,
};
...
pub struct Op505PanelParams<'a> {
    ...
    /// フィードバックのベロシティ感度深さ(0〜255)。V.GAIN/VELと同じ線形カーブ。
    pub feedback_velocity_sens: Box<dyn IntParamHandle + 'a>,
