...
使い方:
    ...
    python organ_template.py --bank private/hand_designed/organ_family.op505
"""
...
def make_reed_patch(
    ...
    ops = [
        op505_patch.make_op(tl=mod_tl0, ar=ar,  d1r=d1r,      d2r=0, d1l=d1l0, rr=rr,
             mul=mod_mul, dt1=dt_lo, ksr=0, am_enable=False,
             velocity_sensitivity=0, waveform=mod_wf, op_fine_tune=128),
        op505_patch.make_op(tl=mod_tl1, ar=ar,  d1r=d1r + 25, d2r=0, d1l=255,  rr=rr,
             mul=mod_mul, dt1=dt_hi, ksr=0, am_enable=False,
             velocity_sensitivity=0, waveform=mod_wf, op_fine_tune=128),
        op505_patch.make_op(tl=196,     ar=166, d1r=17,        d2r=0, d1l=255,  rr=rr,
             mul=1,       dt1=128, ksr=0, am_enable=False,
             velocity_sensitivity=0, waveform=car_wf, op_fine_tune=128),
        op505_patch.make_op(tl=254,     ar=149, d1r=68,        d2r=0, d1l=238,  rr=rr,
