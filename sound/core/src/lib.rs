...
pub use time_eg::{
    ...
    tempo_speed_scale, time_eg_speed_scale, time_to_seconds, TimeEg, TimeEgParams, TimeStage,
    BIPOLAR_NEUTRAL_LEVEL, BIPOLAR_NEUTRAL_RAW, MAX_STAGES, RETRIGGER_MODE_CONTINUE,
    RETRIGGER_MODE_RESET, SYNC_NOTE_COUNT, TEXTURE_CHAOS, TEXTURE_OFF, TEXTURE_RANDOM,
    TEXTURE_SAMPLE_HOLD, TEXTURE_SAW_DOWN, TEXTURE_SAW_UP, TEXTURE_SQUARE, TEXTURE_TRIANGLE,
};
